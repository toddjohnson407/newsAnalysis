...
var start;
var end;
var update = document.getElementById('submit-button');
...
async function createGraph(stockDataPoints, startDate, endDate, ticker) {
  ...
  var prices = [];
  var dates = Object.keys(stockDataPoints).sort();

  for (var i = 0; i < dates.length; i++) {
    var matchedDate = dates[i];
    var price = stockDataPoints[matchedDate];
    prices.push(price);
  }
...
var collectData = function(day, month, year, ticker) {
  ...
  stockdata.historicalDay({
    symbols: `${ticker}`,
    API_TOKEN: 'DnoZzF3tTkqmRARBLzRXAfWH4m896R7MKPHF6DplG9fNIWaqfw4SxdWYHTxE',
    options: {
      date: date,
    },
  })
    .then(response => {
      var open = parseFloat(response.data[0].data.open);
      var close = parseFloat(response.data[0].data.close);
      var meanPrice = ((open + close) / 2).toFixed(2);
      stockDataPoints[`${date}`] = `${meanPrice}`;
      if (Object.values(stockDataPoints).length == totalWeeks) {
        createGraph(stockDataPoints, start, end, ticker);
      }
    })
    .catch(error =>{
      if (error instanceof TypeError) {
        var dayString = (parseInt(day) < 11 ) ? `0${(parseInt(day) - 1).toString()}`:parseInt(day - 1).toString();
        if (parseInt(day) < 2) {
          dayString = '28';
        }
        // console.log('TypeError');
        return collectData(dayString, month, year, ticker);
      }
      else if (typeof error == 'object') {
        if (parseInt(day) < 11) {
          day = `0${parseInt(day) - 1}`;
          console.log(typeof error + ": " + day);
          throw error;
          // return collectData(day, month, year);
        } else {
          day = parseInt(day);
          day = `0${day.toString()}`;
          console.log(date);
...
var stockSelection = async function(weeks, date, ticker) {
  for (var i = 0; i < weeks; i++) {
    ...
    collectData(day, month, year, ticker);
  }
}

function renderData(submit) {
  stockDataPoints = [];
  let data = document.getElementsByClassName('form-data');
  startDate = data[1].getAttribute('value');
  ...
  var end = formatData(endDate);
  var startWeeks = (parseInt(startDate) / 1000 / 60 / 60 / 24 / 7);
  var endWeeks = (parseInt(endDate) / 1000 / 60 / 60 / 24 / 7);
  totalWeeks = endWeeks - startWeeks;
  console.log(tickerSymbol);

  stockSelection(totalWeeks, start, tickerSymbol);
}

update.onclick = function() { renderData(this) }
...
},{"stock-data.js":325}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../core/createError":11,"./../core/settle":14,"./../helpers/btoa":18,"./../helpers/buildURL":19,"./../helpers/cookies":21,"./../helpers/isURLSameOrigin":23,"./../helpers/parseHeaders":25,"./../utils":27,"_process":329}],5:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":4,"./adapters/xhr":4,"./helpers/normalizeHeaderName":24,"./utils":27,"_process":329}],17:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":17,"is-buffer":314}],28:[function(require,module,exports){
...
},{"./_fails":71,"./_iobject":84,"./_object-gops":111,"./_object-keys":114,"./_object-pie":115,"./_to-object":149}],105:[function(require,module,exports){
...
},{"./_object-keys":114,"./_object-pie":115,"./_to-iobject":147}],118:[function(require,module,exports){
...
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../../util/fetchData"),formatOptions=require("../../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/forex_history?base=";function historical(){return _historical.apply(this,arguments)}function _historical(){return _historical=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g,h,i;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.base,d=b.convert_to,e=b.API_TOKEN,f=b.options,void 0!==c){a.next=3;break}throw new Error("No base provided, add a base as an argument");case 3:if(void 0!==e){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:if(void 0!==d){a.next=7;break}throw new Error("No convert_to provided, add convert_to as an argument");case 7:return a.prev=7,g=formatOptions(f),h="".concat(c,"&convert_to=").concat(d),a.next=12,fetchData(URL,h,g,e);case 12:if(i=a.sent,"Invalid API Key."!==i.message){a.next=15;break}throw new Error("Invalid API Token");case 15:return a.abrupt("return",i);case 18:throw a.prev=18,a.t0=a["catch"](7),a.t0;case 21:case"end":return a.stop();}},a,null,[[7,18]])})),_historical.apply(this,arguments)}module.exports=historical;
},{"../../util/fetchData":326,"../../util/formatOptions":327}],318:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../../util/fetchData"),formatOptions=require("../../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/forex_single_day?base=";function historicalDay(){return _historicalDay.apply(this,arguments)}function _historicalDay(){return _historicalDay=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.base,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No base provided, add a base as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:if(void 0!==e&&void 0!==e.date){a.next=7;break}throw new Error("No date provided, add date as an argument");case 7:return a.prev=7,f=formatOptions(e),a.next=11,fetchData(URL,c,f,d);case 11:if(g=a.sent,"Invalid API Key."!==g.message){a.next=14;break}throw new Error("Invalid API Token");case 14:return a.abrupt("return",g);case 17:throw a.prev=17,a.t0=a["catch"](7),a.t0;case 20:case"end":return a.stop();}},a,null,[[7,17]])})),_historicalDay.apply(this,arguments)}module.exports=historicalDay;
},{"../../util/fetchData":326,"../../util/formatOptions":327}],319:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../../util/fetchData"),formatOptions=require("../../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/forex?base=";function realtime(){return _realtime.apply(this,arguments)}function _realtime(){return _realtime=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.base,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No base provided, add a base as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:return a.prev=5,f=formatOptions(e),a.next=9,fetchData(URL,c,f,d);case 9:if(g=a.sent,"Invalid API Key."!==g.message){a.next=12;break}throw new Error("Invalid API Token");case 12:return a.abrupt("return",g);case 15:throw a.prev=15,a.t0=a["catch"](5),a.t0;case 18:case"end":return a.stop();}},a,null,[[5,15]])})),_realtime.apply(this,arguments)}module.exports=realtime;
},{"../../util/fetchData":326,"../../util/formatOptions":327}],320:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../util/fetchData"),formatOptions=require("../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/history?symbol=";function historical(){return _historical.apply(this,arguments)}function _historical(){return _historical=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.symbol,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No symbol provided, add a symbol as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:return a.prev=5,f=formatOptions(e),a.next=9,fetchData(URL,c,f,d);case 9:if(g=a.sent,"Invalid API Key."!==g.message){a.next=12;break}throw new Error("Invalid API Token");case 12:return a.abrupt("return",g);case 15:throw a.prev=15,a.t0=a["catch"](5),a.t0;case 18:case"end":return a.stop();}},a,null,[[5,15]])})),_historical.apply(this,arguments)}module.exports=historical;
},{"../util/fetchData":326,"../util/formatOptions":327}],321:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}function _slicedToArray(a,b){return _arrayWithHoles(a)||_iterableToArrayLimit(a,b)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function _iterableToArrayLimit(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!(b&&c.length===b));d=!0);}catch(a){e=!0,f=a}finally{try{d||null==h["return"]||h["return"]()}finally{if(e)throw f}}return c}function _arrayWithHoles(a){if(Array.isArray(a))return a}var fetchData=require("../util/fetchData"),formatOptions=require("../util/formatOptions"),makeQueries=require("../util/makeQueries"),URL="https://www.worldtradingdata.com/api/v1/history_multi_single_day?symbol=";function mergeData(a){var b={date:a[0].date,data:[]};return a.forEach(function(a){for(var c=Object.entries(a.data),d=0;d<c.length;d++){var e=_slicedToArray(c[d],2),f=e[0],g=e[1];b.data.push({symbol:f,data:g})}}),b}function historicalDay(){return _historicalDay.apply(this,arguments)}function _historicalDay(){return _historicalDay=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g,h,i,j,k,l,m,n,o;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.symbols,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No symbol provided, add a symbol as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:if(void 0!==e&&void 0!==e.date){a.next=7;break}throw new Error("No date provided, add date as an argument");case 7:return f=formatOptions(e),a.prev=8,g=[],a.next=12,makeQueries(c,2);case 12:for(h=a.sent,i=!0,j=!1,k=void 0,a.prev=16,l=h[Symbol.iterator]();!(i=(m=l.next()).done);i=!0)n=m.value,g.push(fetchData(URL,n,f,d));a.next=24;break;case 20:a.prev=20,a.t0=a["catch"](16),j=!0,k=a.t0;case 24:a.prev=24,a.prev=25,i||null==l.return||l.return();case 27:if(a.prev=27,!j){a.next=30;break}throw k;case 30:return a.finish(27);case 31:return a.finish(24);case 32:return a.next=34,Promise.all(g);case 34:if(o=a.sent,"Invalid API Key."!==o[0].message){a.next=37;break}throw new Error("Invalid API Token");case 37:return a.abrupt("return",mergeData(o));case 40:throw a.prev=40,a.t1=a["catch"](8),a.t1;case 43:case"end":return a.stop();}},a,null,[[8,40],[16,20,24,32],[25,,27,31]])})),_historicalDay.apply(this,arguments)}module.exports=historicalDay;
},{"../util/fetchData":326,"../util/formatOptions":327,"../util/makeQueries":328}],322:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../util/fetchData"),formatOptions=require("../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/intraday?symbol=";function historical(){return _historical.apply(this,arguments)}function _historical(){return _historical=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.symbol,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No symbol provided, add a symbol as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:if(void 0!==e&&void 0!==e.range){a.next=7;break}throw new Error("No range provided in options, add a range as an argument");case 7:if(void 0!==e&&void 0!==e.interval){a.next=9;break}throw new Error("No interval provided options, add a interval as an argument");case 9:if(!(1===e.interval&&7<e.range)){a.next=11;break}throw new Error("If the interval is 1 min, the max range is 7");case 11:return a.prev=11,f=formatOptions(e),a.next=15,fetchData(URL,c,f,d);case 15:if(g=a.sent,"Invalid API Key."!==g.message){a.next=18;break}throw new Error("Invalid API Token");case 18:return a.abrupt("return",g);case 21:throw a.prev=21,a.t0=a["catch"](11),a.t0;case 24:case"end":return a.stop();}},a,null,[[11,21]])})),_historical.apply(this,arguments)}module.exports=historical;
},{"../util/fetchData":326,"../util/formatOptions":327}],323:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../util/fetchData"),makeQueries=require("../util/makeQueries"),formatOptions=require("../util/formatOptions"),STOCK_URL="https://www.worldtradingdata.com/api/v1/stock?symbol=",FUND_URL="https://www.worldtradingdata.com/api/v1/mutualfund?symbol=";function mergeData(a){var b={symbols_requested:0,symbols_returned:0,data:[]};return a.forEach(function(a){b.symbols_requested+=a.symbols_requested,b.symbols_returned+=a.symbols_returned,b.data=b.data.concat(a.data)}),b}function realtime(){return _realtime.apply(this,arguments)}function _realtime(){return _realtime=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g,h,i,j,k,l,m,n,o,p,q;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.symbols,d=b.API_TOKEN,e=b.FUND,f=b.options,g=e?FUND_URL:STOCK_URL,void 0!==c){a.next=4;break}throw new Error("No symbols provided, add symbols as an argument");case 4:if(void 0!==d){a.next=6;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 6:return h=formatOptions(f),a.prev=7,i=[],a.next=11,makeQueries(c,5);case 11:for(j=a.sent,k=!0,l=!1,m=void 0,a.prev=15,n=j[Symbol.iterator]();!(k=(o=n.next()).done);k=!0)p=o.value,i.push(fetchData(g,p,h,d));a.next=23;break;case 19:a.prev=19,a.t0=a["catch"](15),l=!0,m=a.t0;case 23:a.prev=23,a.prev=24,k||null==n.return||n.return();case 26:if(a.prev=26,!l){a.next=29;break}throw m;case 29:return a.finish(26);case 30:return a.finish(23);case 31:return a.next=33,Promise.all(i);case 33:if(q=a.sent,"Invalid API Key."!==q[0].message){a.next=36;break}throw new Error("Invalid API Token");case 36:return a.abrupt("return",mergeData(q));case 39:throw a.prev=39,a.t1=a["catch"](7),a.t1;case 42:case"end":return a.stop();}},a,null,[[7,39],[15,19,23,31],[24,,26,30]])})),_realtime.apply(this,arguments)}module.exports=realtime;
},{"../util/fetchData":326,"../util/formatOptions":327,"../util/makeQueries":328}],324:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var fetchData=require("../util/fetchData"),formatOptions=require("../util/formatOptions"),URL="https://www.worldtradingdata.com/api/v1/stock_search?search_term=";function search(){return _search.apply(this,arguments)}function _search(){return _search=_asyncToGenerator(regeneratorRuntime.mark(function a(b){var c,d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(c=b.search_term,d=b.API_TOKEN,e=b.options,void 0!==c){a.next=3;break}throw new Error("No search provided, add a search term as an argument");case 3:if(void 0!==d){a.next=5;break}throw new Error("No API_TOKEN provided, add your API_TOKEN from https://www.worldtradingdata.com/ as an argument");case 5:return a.prev=5,f=formatOptions(e),a.next=9,fetchData(URL,c,f,d);case 9:if(g=a.sent,"Invalid API Key."!==g.message){a.next=12;break}throw new Error("Invalid API Token");case 12:return a.abrupt("return",g);case 15:throw a.prev=15,a.t0=a["catch"](5),a.t0;case 18:case"end":return a.stop();}},a,null,[[5,15]])})),_search.apply(this,arguments)}module.exports=search;
},{"../util/fetchData":326,"../util/formatOptions":327}],325:[function(require,module,exports){
"use strict";require("@babel/polyfill"),module.exports={realtime:require("./functions/realtime"),historical:require("./functions/historical"),historicalDay:require("./functions/historicalDay"),search:require("./functions/search"),intraday:require("./functions/intraday"),forex:{realtime:require("./functions/forex/realtime"),historical:require("./functions/forex/historical"),historicalDay:require("./functions/forex/historicalDay")}};
},{"./functions/forex/historical":317,"./functions/forex/historicalDay":318,"./functions/forex/realtime":319,"./functions/historical":320,"./functions/historicalDay":321,"./functions/intraday":322,"./functions/realtime":323,"./functions/search":324,"@babel/polyfill":2}],326:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}var axios=require("axios").default;module.exports=function(){var a=_asyncToGenerator(regeneratorRuntime.mark(function a(b,c,d,e){return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:return a.abrupt("return",axios.get("".concat(b).concat(c).concat(d,"api_token=").concat(e)).then(function(a){return a.data}).catch(function(a){throw new Error(a)}));case 1:case"end":return a.stop();}},a)}));return function(){return a.apply(this,arguments)}}();
},{"axios":3}],327:[function(require,module,exports){
"use strict";var moment=require("moment"),VISIT="Visit https://www.worldtradingdata.com/ for more information",DATE_ERROR="must be in the valid format YYYY-MM-DD.";function validDate(a){return moment(a,"YYYY-MM-DD",!0).isValid()}function checkCorrectOptions(a){var b=a.date_from,c=a.date_to,d=a.sort,e=a.formatted,f=a.date,g=a.search_by,h=a.limit,i=a.sort_by,j=a.sort_order,k=a.interval,l=a.range;if(b!==void 0&&!validDate(b))throw new Error("date_from ".concat(DATE_ERROR," ").concat(VISIT));if(void 0!==c&&!validDate(c))throw new Error("date_to ".concat(DATE_ERROR," ").concat(VISIT));if(void 0!==d&&-1===["newest","oldest","desc","asc"].indexOf(d))throw new Error("sort has not any of the valid options. Use newest, oldest, desc, asc. ".concat(VISIT));if(void 0!==e&&"boolean"!=typeof e)throw new Error("formatted should be a boolean. ".concat(VISIT));if(void 0!==f&&!validDate(f))throw new Error("date ".concat(DATE_ERROR," ").concat(VISIT));if(void 0!==g&&-1===["symbol,name","symbol","name"].indexOf(g))throw new Error("search_by has not any of the valid options. Use [symbol,name], name, symbol ".concat(VISIT));if(void 0!==h&&(1>+h||500<+h))throw new Error("limit value should be between 1-500 ".concat(VISIT));if(void 0!==i&&-1===["symbol","name","currency","stock_exchange_long","stock_exchange_short","market_cap","volume","change_pct"].indexOf(i))throw new Error("sort_by has not any of the valid options. ".concat(VISIT));if(void 0!==j&&-1===["desc","asc"].indexOf(j))throw new Error("sort_order has not any of the valid options. Use desc, asc. ".concat(VISIT));if(void 0!==k&&-1===[1,2,5,60].indexOf(+k))throw new Error("interval has not any of the valid options. Use 1, 2, 5, 60. ".concat(VISIT));if(void 0!==l&&(1>+l||30<+l))throw new Error("range value should be between 1-30 ".concat(VISIT))}function formatOptions(a){var b="&";if(void 0===a)return b;try{checkCorrectOptions(a)}catch(a){throw a}var c=a.date_from,d=a.date_to,e=a.sort,f=a.formatted,g=a.date,h=a.interval,i=a.range,j=a.search_by,k=a.stock_exchange,l=a.currency,m=a.limit,n=a.page,o=a.sort_by,p=a.sort_order;return b+=void 0===c?"":"date_from=".concat(c,"&"),b+=void 0===d?"":"date_to=".concat(d,"&"),b+=void 0===e?"":"sort=".concat(e,"&"),b+=void 0===f?"":"formatted=".concat(f,"&"),b+=void 0===j?"":"search_by=".concat(j,"&"),b+=void 0===k?"":"stock_exchange=".concat(k,"&"),b+=void 0===l?"":"currency=".concat(l,"&"),b+=void 0===m?"":"limit=".concat(m,"&"),b+=void 0===o?"":"sort_by=".concat(o,"&"),b+=void 0===p?"":"sort_order=".concat(p,"&"),b+=void 0===g?"":"date=".concat(g,"&"),b+=void 0===n?"":"page=".concat(n,"&"),b+=void 0===h?"":"interval=".concat(h,"&"),b+=void 0===i?"":"range=".concat(i,"&"),b}module.exports=formatOptions;
},{"moment":315}],328:[function(require,module,exports){
"use strict";function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}function symbolsQuery(){return _symbolsQuery.apply(this,arguments)}function _symbolsQuery(){return _symbolsQuery=_asyncToGenerator(regeneratorRuntime.mark(function a(b,c){var d,e,f,g;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if("string"!=typeof b){a.next=2;break}return a.abrupt("return",[b]);case 2:for(d=[],e=Math.ceil(b.length/c),f=0;f<e;f+=1)g=c*f,d.push(b.slice(g,g+c).join(","));return a.abrupt("return",d);case 6:case"end":return a.stop();}},a)})),_symbolsQuery.apply(this,arguments)}module.exports=symbolsQuery;
